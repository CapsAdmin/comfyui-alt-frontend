...
function applyCrop(img: Konva.Image, pos: CropMode) {
    const crop = getCrop(img.image()! as HTMLImageElement, { width: img.width(), height: img.height() }, pos);
    img.setAttrs(crop);
}
...
export const Editor = () => {
    return (
        <Stage width={512} height={512}>
            <Layer>
            <Gizmo>
                    <CroppedImage url="https://konvajs.org/assets/yoda.jpg" cropMode="center-middle" />
                </Gizmo>
